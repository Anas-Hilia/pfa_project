                    ...
                    <div class="card-header">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                ...
                                {!! trans('Showing branches recently created') !!}
                                ...
                                <tbody id="brancheFs_table">
                                    @foreach($brancheFs as $brancheF)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('/branches/created/' . $brancheF->id_BrF.'/accept') }}" data-toggle="tooltip" title="Show">
                                                    {!! trans('Accept') !!}
                                                </a>
                                            </td>
                                            <td>
                                                {!! Form::open(array('url' => '/branches/created/' . $brancheF->id_BrF.'/refuse', 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete formation')) !!}
