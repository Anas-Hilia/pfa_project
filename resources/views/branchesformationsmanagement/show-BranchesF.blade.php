                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                @if (Route::currentRouteName()=='BranchesFs_prof')
                                    {!! trans("Showing branches of formations where you're coordinator") !!}
                                @else
                                    {!! trans('Showing-branches') !!}
                                @endif
                            </span>
                                    ...
                                    <tbody id="brancheFs_table">
                                        @foreach($brancheFs as $brancheF)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('BranchesFs/' . $brancheF->id_BrF) }}" data-toggle="tooltip" title="Show">
                                                        {!! trans('show') !!}
                                                    </a>
                                                </td>
                                                @if($brancheF->coordinateur==Auth::User()->id || Auth::User()->currentUserRole==1)
                                                    ...
                                                    <td>
                                                        <a class="btn btn-sm btn-info btn-block" href="{{ URL::to('BranchesFs/' . $brancheF->id_BrF . '/edit') }}" data-toggle="tooltip" title="Edit">
                                                            {!! trans('edit') !!}
                                                        </a>
                                                    </td>
                                                    <td>
                                                        {!! Form::open(array('url' => 'BranchesFs/' . $brancheF->id_BrF , 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete brancheF')) !!}
                                                            {!! Form::hidden('_method', 'DELETE') !!}
                                                            {!! Form::button(trans('delete'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete Branche of Formation', 'data-message' => 'Are you sure you want to delete this branche of Formation ?')) !!}
                                                        {!! Form::close() !!}
                                                    </td>
