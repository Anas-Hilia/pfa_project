                    ...
                    <div class="card-header">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                ...
                                {!! trans('showing formations recently created') !!}
                                    ...
                                    @foreach($formations as $formation)
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <a class="btn btn-sm btn-success btn-block" href="{{ URL::to('/formations/created/' . $formation->id.'/accept') }}" data-toggle="tooltip" title="Show">
                                                    {!! trans('Accept') !!}
                                                </a>
                                            </td>
                                            <td>
                                                {!! Form::open(array('url' => '/formations/created/' . $formation->id.'/refuse', 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'Delete formation')) !!}
                                                    {!! Form::button(trans('Refuse'), array('class' => 'btn btn-danger btn-sm','type' => 'button', 'style' =>'width: 100%;' ,'data-toggle' => 'modal', 'data-target' => '#confirmDelete', 'data-title' => 'Delete formation', 'data-message' => 'Are you sure you want to refuse creation of this formation ?')) !!}
                                                {!! Form::close() !!}
                                            </td>
